...
import me.ryanhamshire.GriefPrevention.claims.CreateClaimResult;
import me.ryanhamshire.GriefPrevention.claims.CustomLogEntryTypes;
...
import me.ryanhamshire.GriefPrevention.util.VisualizationType;
...
public class MainCommands
{
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args)
    {
        ...
        else if (cmd.getName().equalsIgnoreCase("transferclaim") && player != null)
        {
            ...
            if (args.length > 0)
            {
                OfflinePlayer targetPlayer = GriefPrevention.instance.resolvePlayerByName(args[0]);
        ...
        else if (cmd.getName().equalsIgnoreCase("trustlist") && player != null)
        {
            ...
            player.sendMessage(
                    ChatColor.GOLD + GriefPrevention.instance.dataStore.getMessage(Messages.Manage) + " " +
                            ChatColor.YELLOW + GriefPrevention.instance.dataStore.getMessage(Messages.Build) + " " +
                            ChatColor.GREEN + GriefPrevention.instance.dataStore.getMessage(Messages.Containers) + " " +
                            ChatColor.BLUE + GriefPrevention.instance.dataStore.getMessage(Messages.Access));
        ...
        else if (cmd.getName().equalsIgnoreCase("untrust") && player != null)
        {
            ...
            else
            {
                ...
                {
                    otherPlayer = GriefPrevention.instance.resolvePlayerByName(args[0]);
        ...
        else if (cmd.getName().equalsIgnoreCase("buyclaimblocks") && player != null)
        {
            ...
            EconomyHandler.EconomyWrapper economyWrapper = GriefPrevention.instance.economyHandler.getWrapper();
        ...
        else if (cmd.getName().equalsIgnoreCase("deleteallclaims"))
        {
            ...
            OfflinePlayer otherPlayer = GriefPrevention.instance.resolvePlayerByName(args[0]);
            if (otherPlayer == null)
            {
                GriefPrevention.sendMessage(player, TextMode.Err, Messages.PlayerNotFound2);
                return true;
        ...
        else if (cmd.getName().equalsIgnoreCase("claimslist"))
        {
            ...
            if (claims.size() > 0)
            {
                ...
                for (int i = 0; i < playerData.getClaims().size(); i++)
                {
                    ...
                    GriefPrevention.sendMessage(player, TextMode.Instr, GriefPrevention.getfriendlyLocationString(claim.getLesserBoundaryCorner()) + GriefPrevention.instance.dataStore.getMessage(Messages.ContinueBlockMath, String.valueOf(claim.getArea())));
                }
        ...
        else if (cmd.getName().equalsIgnoreCase("adjustbonusclaimblocks"))
        {
            ...
            {
                targetPlayer = GriefPrevention.instance.resolvePlayerByName(args[0]);
            }
        ...
        else if (cmd.getName().equalsIgnoreCase("trapped") && player != null)
        {
            ...
            GriefPrevention.instance.getServer().getScheduler().scheduleSyncDelayedTask(GriefPrevention.instance, task, 200L);  //20L ~ 1 second
        ...
        else if (cmd.getName().equalsIgnoreCase("siege") && player != null)
        {
            ...
            PlayerData attackerData = GriefPrevention.instance.dataStore.getPlayerData(player.getUniqueId());
            ...
            if (args.length >= 1)
            {
                defender = GriefPrevention.instance.getServer().getPlayer(args[0]);
                if (defender == null)
                {
                    GriefPrevention.sendMessage(player, TextMode.Err, Messages.PlayerNotFound2);
                    return true;
            ...
            {
                defender = GriefPrevention.instance.getServer().getPlayer(attackerData.lastPvpPlayer);
                if (defender == null)
                {
                    return false;
                }
            ...
            if (GriefPrevention.instance.dataStore.onCooldown(player, defender, defenderClaim))
            {
            ...
            //start the siege
            GriefPrevention.instance.dataStore.startSiege(player, defender, defenderClaim);
        ...
        else if (cmd.getName().equalsIgnoreCase("separate"))
        {
            ...
            OfflinePlayer targetPlayer2 = GriefPrevention.instance.resolvePlayerByName(args[1]);
